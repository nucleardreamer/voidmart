// Taken from here and messed with a bunch... https://github.com/commodo/glitch-animation-effect
...
glitch_exec = {
    ...
    NR_OF_GLITCHED_CANVASES: window.GLITCH_COUNT || 7,
    GLITCH_RENDER_COUNT: 0, /* 0 or negative == glitch indefinitely ; > 0 == glich & few times and stop */
    GLITCH_INTERVAL_PROGRESSIVE: 1,
    GLITCH_INTERVAL_MIN: window.GLITCH_MIN || 500, /* millisecs */
    GLITCH_INTERVAL_MAX: window.GLITCH_MAX || 1500, /* millisecs */
    DELAY_BETWEEN_FRAMES: window.GLITCH_DELAY || 60,  /* 30 milisecs delay */
        ...
        for (var i = 0; i < gl.NR_OF_GLITCHED_CANVASES; ++i) {
            glitch(gl.object_to_glitch, {
                ...
                complete: function (canvas) {
                    ...
                    canvas.style['z-index'] = "1000"; // ehhh, probably stupid but might as well hard code the canvas on top of stuff rather than through a css class
